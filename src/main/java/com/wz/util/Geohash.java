...
/***********************获取九个的矩形编码****************************************/
	...
	final public static Map<String, String> BORDERS = new HashMap<String, String>();
	final public static Map<String, String> NEIGHBORS = new HashMap<String, String>();
	 ...
	 * @return 经/纬值
	 */
	public double decode(BitSet bs, double floor, double ceiling) {
		double mid = 0;
